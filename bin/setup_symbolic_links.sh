...
target_paths=("$HOME/.zshrc" "$HOME/.config/nvim/coc-settings.json" "$HOME/.config/nvim/init.lua" "$HOME/.config/nvim/cheatsheet.txt" "$HOME/.tmux.conf" "$HOME/.config/nvim/lua" "$HOME/mcp.json" "$HOME/.cursor/mcp.json" "$HOME/.gemini" "$HOME/.cursor/mcp.json" "$HOME"/.tmux)
link_paths=("$DOTFILES_DIR/.zshrc" "$DOTFILES_DIR/coc-settings.json" "$DOTFILES_DIR/init.lua" "$DOTFILES_DIR/cheatsheet.txt" "$DOTFILES_DIR/tmux/tmux.common.conf" "$DOTFILES_DIR/lua" "$DOTFILES_DIR/config/mcp/mcp.json" "$DOTFILES_DIR/config/mcp/mcp.json" "$DOTFILES_DIR/config/gemini-cli" "$DOTFILES_DIR/config/cursor/mcp.json" "$DOTFILES_DIR/tmux")
